...
const RealmeNew = () => {
  ...
  const currentPosts = realme.slice(firstPostIndex, lastPostIndex);
          ...
          <div className="applesortsection">
            <div className="appleheading">
              ...
              (Showing <span>{firstPostIndex + 1}</span> -{" "}
                ...
                of <span>{realme.length}</span> products)
              </p>
            </div>
          ...
          <div className="appleproductlists">
            {realme.map((item) => {
              return (
                <>
                  <a
                    href={`/realmeproductdetails/${item.id}`}
                    style={{ color: "blue" }}
                  >
