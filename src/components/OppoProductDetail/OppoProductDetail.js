...
import { oppodetail } from "../Data/OppoProductDetailing";


const OppoProductDetail = ({ cart, setCart }) => {
  const { id } = useParams();
  const [product, setProduct] = useState({});

  useEffect(() => {
    const filterProduct = oppodetail.filter(
...
export default OppoProductDetail;
