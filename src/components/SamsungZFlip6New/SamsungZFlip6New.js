...
const SamsungZFlip6New = () => {
  ...
  const currentPosts = samsungZFlip6.slice(firstPostIndex, lastPostIndex);
      ...
      <div className="applecontainer">
        ...
        <div className="applerightcontainer">
          ...
          <div className="applesortsection">
            <div className="appleheading">
              ...
              (Showing <span>{firstPostIndex + 1}</span> -{" "}
                ...
                of <span>{samsungZFlip6.length}</span> products)
              </p>
            </div>
          ...
          <div className="appleproductlists">
            {samsungZFlip6.map((item) => {
              return (
                <>
                  <a
                    href={`/samsungZFlip6details/${item.id}`}
                    style={{ color: "blue" }}
                  >
...
export default SamsungZFlip6New;
