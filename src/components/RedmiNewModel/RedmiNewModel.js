...
const RedmiNewModel = () => {
  ...
  const currentPosts = redminew.slice(firstPostIndex, lastPostIndex);
          ...
          <div className="applesortsection">
            <div className="appleheading">
              ...
              (Showing <span>{firstPostIndex + 1}</span> -{" "}
                ...
                of <span>{redminew.length}</span> products)
              </p>
            </div>
