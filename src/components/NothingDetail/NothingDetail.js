...
import { nothing } from "../Data/Nothingproduct";
...
const NothingDetail = () => {
  ...
  const currentPosts = nothing.slice(firstPostIndex, lastPostIndex);
          ...
          <div className="applesortsection">
            <div className="appleheading">
              ...
              <p className="appleproductcount">
                ...
                of <span>{nothing.length}</span> products)
              </p>
            </div>
