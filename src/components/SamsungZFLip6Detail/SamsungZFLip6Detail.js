...
import { samsungZFlip6 } from "../Data/SamsungZFLip6";


const SamsungZFlip6Detail = ({ cart, setCart }) => {
  const { id } = useParams();
  const [product, setProduct] = useState({});

  useEffect(() => {
    const filterProduct = samsungZFlip6.filter(
      ...
      <div className="productContainer">
        <div className="productlayout">
          ...
          <div className="productdescription">
            ...
            <div className="redmimobilewarranty">
              <div className="redmimobilewarrentyimg">
                <img src={product.warrentyImg} alt="" />
              </div>
              <div className="redmimobilewarrentydetails">
...
export default SamsungZFlip6Detail;
