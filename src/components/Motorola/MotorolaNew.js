...
const MotorolaNew = () => {
  ...
  const currentPosts = motorola.slice(firstPostIndex, lastPostIndex);
          ...
          <div className="applesortsection">
            <div className="appleheading">
              ...
              (Showing <span>{firstPostIndex + 1}</span> -{" "}
                ...
                of <span>{motorola.length}</span> products)
              </p>
            </div>
