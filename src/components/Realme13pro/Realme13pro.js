...
const Realme13pro = () => {
  ...
  const currentPosts = realme13pro.slice(firstPostIndex, lastPostIndex);
  return (
    <>
      <div className="applecontainer">
        ...
        <div className="applerightcontainer">
          ...
          <div className="applesortsection">
            <div className="appleheading">
              ...
              <p className="appleproductcount">
                ...
                of <span>{realme13pro.length}</span> products)
              </p>
            </div>
          ...
          <div className="appleproductlists">
            {realme13pro.map((item) => {
              return (
                <>
                  <a href={`/realme13prodetails/${item.id}`}>
