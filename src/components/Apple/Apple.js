...
import { apple } from "../Data/Applelists";
...
const Apple = () => {
  ...
  const currentPosts = apple.slice(firstPostIndex, lastPostIndex);
  return (
    <>
          ...
          <div className="applesortsection">
            <div className="appleheading">
              ...
              <p className="appleproductcount">
                ...
                of <span>{apple.length}</span> products)
              </p>
            </div>
