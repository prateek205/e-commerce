...
import { motorola } from "../Data/Motolist";

const MotorolaProductDetail = ({ cart, setCart }) => {
  const { id } = useParams();
  const [product, setProduct] = useState({});

  useEffect(() => {
    const filterProduct = motorola.filter(
      ...
      <div className="productContainer">
        <div className="productlayout">
          ...
          <div className="productdescription">
            ...
            <div className="motorolamobilewarranty">
              <div className="motorolamobilewarrentyimg">
                <img src={product.warrentyImg} alt="" />
              </div>
              <div className="motorolamobilewarrentydetails">
...
export default MotorolaProductDetail;
