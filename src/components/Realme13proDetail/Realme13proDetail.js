...
import { realme13pro } from "../Data/Realme13proData";

const Realme13proDetail = ({ cart, setCart }) => {
  const { id } = useParams();
  const [product, setProduct] = useState({});

  useEffect(() => {
    const filterProduct = realme13pro.filter(
...
export default Realme13proDetail;
