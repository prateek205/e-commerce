...
const SamsungProductDetail = ({ cart, setCart }) => {
  const { id } = useParams();
  const [product, setProduct] = useState({});

  useEffect(() => {
    const filterProduct = samsung.filter(
      ...
      <div className="productContainer">
        <div className="productlayout">
          ...
          <div className="productdescription">
            ...
            <div className="samsungmobilewarranty">
              <div className="samsungmobilewarrentyimg">
                <img src={product.warrentyImg} alt="" />
              </div>
              <div className="samsungmobilewarrentydetails">
            ...
            <div className="productindepthdesc">
              ...
              <div className="productlayout6">
                <div className="productUSBimg">
                  <img src={product.heading6Img} alt="" />
                </div>
                <div className="productUSB">
                  <div className="productUSBtitle">
                    <p>{product.heading6}</p>
                  </div>
                  <div className="productUSBinformation">
                    <p>{product.info6}</p>
                  </div>
              ...
              <div className="productlayout7">
                <div className="productUSB">
                  <div className="productUSBtitle">
                    <p>{product.heading7}</p>
                  </div>
                  <div className="productUSBinformation">
                    <p>{product.info7}</p>
                  </div>
                ...
                <div className="productUSBimg">
                  <img src={product.heading7Img} alt="" />
                </div>
              </div>
              <div className="productlayout8">
                <div className="productUSBimg">
                  <img src={product.heading8Img} alt="" />
                </div>
                <div className="productUSB">
                  <div className="productUSBtitle">
                    <p>{product.heading8}</p>
                  </div>
                  <div className="productUSBinformation">
                    <p>{product.info8}</p>
                  </div>
              ...
              <div className="productlayout9">
                <div className="productUSB">
                  <div className="productUSBtitle">
                    <p>{product.heading9}</p>
                  </div>
                  <div className="productUSBinformation">
                    <p>{product.info9}</p>
                  </div>
                ...
                <div className="productUSBimg">
                  <img src={product.heading9Img} alt="" />
                </div>
              </div>
              <div className="productlayout10">
                <div className="productUSBimg">
                  <img src={product.heading10Img} alt="" />
                </div>
                <div className="productUSB">
                  <div className="productUSBtitle">
                    <p>{product.heading10}</p>
                  </div>
                  <div className="productUSBinformation">
                    <p>{product.info10}</p>
                  </div>
              ...
              <div className="productlayout11">
                <div className="productUSB">
                  <div className="productUSBtitle">
                    <p>{product.heading11}</p>
                  </div>
                  <div className="productUSBinformation">
                    <p>{product.info11}</p>
                  </div>
                ...
                <div className="productUSBimg">
                  <img src={product.heading11Img} alt="" />
                </div>
              </div>
            </div>
          </div>
...
export default SamsungProductDetail;
