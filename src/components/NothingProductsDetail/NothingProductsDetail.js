...
import { nothingDetail } from "../Data/NothingProductDetail";

const NothingProductsDetail = ({ cart, setCart }) => {
  const { id } = useParams();
  const [product, setProduct] = useState({});

  useEffect(() => {
    const filterProduct = nothingDetail.filter(
...
export default NothingProductsDetail;
