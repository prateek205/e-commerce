...
import { xiaomi } from "../Data/Xiaomi14Civi";
...
const XiaomiProduct = () => {
  ...
  const currentPosts = xiaomi.slice(firstPostIndex, lastPostIndex);
        ...
        <div className="applerightcontainer">
          ...
          <div className="applesortsection">
            <div className="appleheading">
              ...
              (Showing <span>{firstPostIndex + 1}</span> -{" "}
                ...
                of <span>{xiaomi.length}</span> products)
              </p>
            </div>
          ...
          <div className="appleproductlists">
            {xiaomi.map((item) => {
              return (
                <>
                  <a href={`/xiaomiproductdetails/${item.id}`}style={{color:"blue"}}>
